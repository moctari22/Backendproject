...
import com.shopme.admin.user.export.CategoryExporter;
...
public class CategoryController {
	...
	public String listByPage(@PathVariable(name = "pageNum") int pageNum, Model model,
						@Param("sortDir") String sortDir,@Param("keyword") String keyword,@Param("sortField") String sortField) {
		...
		List<Category> listCategory =   service.listByPage(pageInfo,pageNum,sortDir,keyword);
	...
	public String listFirstPage(@Param("sortDir") String sortDir,Model model) {
		...
		return listByPage(1, model, sortDir,null,"name");
	}
	...
	public void exportToCSV(HttpServletResponse response) throws IOException {
		List<Category> listCategories = service.listByPage("asc");
	...
	public String newCategory(Model model) {
		List<Category> lisCategories = service.listCategoriesUsedInForm();
	...
	public String savedCategory(Category category, RedirectAttributes redirectAttributes, @RequestParam("fileImage") MultipartFile multipartFile) throws IOException
	{
		...
		redirectAttributes.addFlashAttribute("message", "La categorie a été sauvegardé avec succès");
		return "redirect:/categories";
	}
