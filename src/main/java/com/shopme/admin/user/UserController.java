...
public class UserController {
	...
	public String saveUser(User user, RedirectAttributes redirectAttributes, @RequestParam("image") MultipartFile multipartFile) throws IOException {
		...
		redirectAttributes.addFlashAttribute("message", "L'utilitateur a été ajouté avec succès");
	...
	public String deleteUser(@PathVariable(name="id") Integer id , RedirectAttributes redirectAttributes , Model model)
	{
		...
		try {
			service.delete(id);
			redirectAttributes.addFlashAttribute("message", "L'utilitateur a été supprimé avec succès id_user : " + id);
